...
import { addOptions, fetchQuizesStartAsync, resetAll } from '../../redux/quiz/quiz.actions';

const Homepage = ({ addOptions, category, history, fetchQuizesStartAsync, resetAll }) => {
			...
			{showModal && (
				<Modal>
					...
					<div className="content">
						<TextInput
							type="number"
							valid={!(numOfQuestions > 50 || numOfQuestions < 5)}
							validityMessage="can't be less than 5 or greater than 50"
							id="numOfQuestions"
					...
					<footer className="footer">
						<Button danger="danger" handleClick={() => setShowModal(false)}>
							{' '}
							Close{' '}
						</Button>
						<Button
							...
							outline="outline"
							disabled={numOfQuestions > 50 || numOfQuestions < 5}
						>
							{' '}
							Start{' '}
						</Button>
